...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9/clusterrolebinding"
...
&clusterrolebinding.ClusterRoleBindingConfig {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9.clusterRoleBinding.ClusterRoleBindingMetadata,
	RoleRef: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9.clusterRoleBinding.ClusterRoleBindingRoleRef,
	Subject: interface{},
	Id: *string,
}
```
