...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v8/clusterrolebinding"
...
&clusterrolebinding.ClusterRoleBindingConfig {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v8.clusterRoleBinding.ClusterRoleBindingMetadata,
	RoleRef: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v8.clusterRoleBinding.ClusterRoleBindingRoleRef,
	Subject: interface{},
	Id: *string,
}
```
