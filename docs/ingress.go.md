...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v12/ingress"
...
Refer to the {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.37.1/docs/resources/ingress#import import section} in the documentation of this resource for the id to use
...
&ingress.IngressConfig {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v12.ingress.IngressMetadata,
	Spec: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v12.ingress.IngressSpec,
	Id: *string,
...
| <code><a href="#@cdktf/provider-kubernetes.ingress.IngressConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.37.1/docs/resources/ingress#id Ingress#id}. |
...
&ingress.IngressSpec {
	Backend: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v12.ingress.IngressSpecBackend,
...
&ingress.IngressSpecRule {
	Http: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v12.ingress.IngressSpecRuleHttp,
	Host: *string,
}
```
...
&ingress.IngressSpecRuleHttpPath {
	Backend: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v12.ingress.IngressSpecRuleHttpPathBackend,
	Path: *string,
}
```
