...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v7/certificatesigningrequestv1"
...
&certificatesigningrequestv1.CertificateSigningRequestV1Config {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v7.certificateSigningRequestV1.CertificateSigningRequestV1Metadata,
	Spec: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v7.certificateSigningRequestV1.CertificateSigningRequestV1Spec,
	AutoApprove: interface{},
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v7.certificateSigningRequestV1.CertificateSigningRequestV1Timeouts,
}
```
