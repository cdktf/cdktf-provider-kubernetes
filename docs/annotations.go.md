...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v7/annotations"
...
&annotations.AnnotationsConfig {
	...
	ApiVersion: *string,
	Kind: *string,
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v7.annotations.AnnotationsMetadata,
