...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v8/annotations"
...
&annotations.AnnotationsConfig {
	...
	ApiVersion: *string,
	Kind: *string,
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v8.annotations.AnnotationsMetadata,
