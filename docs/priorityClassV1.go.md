...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v8/priorityclassv1"
...
&priorityclassv1.PriorityClassV1Config {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v8.priorityClassV1.PriorityClassV1Metadata,
	Value: *f64,
	Description: *string,
