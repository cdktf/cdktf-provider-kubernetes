...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v7/priorityclassv1"
...
&priorityclassv1.PriorityClassV1Config {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v7.priorityClassV1.PriorityClassV1Metadata,
	Value: *f64,
	Description: *string,
