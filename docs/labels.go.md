...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v12/labels"
...
&labels.LabelsConfig {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v12.labels.LabelsMetadata,
	FieldManager: *string,
	Force: interface{},
	Id: *string,
}
...
| <code><a href="#@cdktf/provider-kubernetes.labels.LabelsConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.37.1/docs/resources/labels#id Labels#id}. |
