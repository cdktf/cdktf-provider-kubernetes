...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v8/labels"
...
&labels.LabelsConfig {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v8.labels.LabelsMetadata,
	FieldManager: *string,
	Force: interface{},
	Id: *string,
}
