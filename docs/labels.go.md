...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v7/labels"
...
&labels.LabelsConfig {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v7.labels.LabelsMetadata,
	FieldManager: *string,
	Force: interface{},
	Id: *string,
}
