...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9/datakubernetesmutatingwebhookconfigurationv1"
...
&datakubernetesmutatingwebhookconfigurationv1.DataKubernetesMutatingWebhookConfigurationV1Config {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9.dataKubernetesMutatingWebhookConfigurationV1.DataKubernetesMutatingWebhookConfigurationV1Metadata,
	Id: *string,
}
```
