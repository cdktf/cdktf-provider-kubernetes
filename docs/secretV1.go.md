...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v8/secretv1"
...
&secretv1.SecretV1Config {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v8.secretV1.SecretV1Metadata,
	BinaryData: *map[string]*string,
	Data: *map[string]*string,
	Id: *string,
	Immutable: interface{},
	Timeouts: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v8.secretV1.SecretV1Timeouts,
	Type: *string,
