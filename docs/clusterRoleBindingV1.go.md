...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v8/clusterrolebindingv1"
...
&clusterrolebindingv1.ClusterRoleBindingV1Config {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v8.clusterRoleBindingV1.ClusterRoleBindingV1Metadata,
	RoleRef: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v8.clusterRoleBindingV1.ClusterRoleBindingV1RoleRef,
	Subject: interface{},
	Id: *string,
}
```
