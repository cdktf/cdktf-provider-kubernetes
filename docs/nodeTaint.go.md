...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9/nodetaint"
...
&nodetaint.NodeTaintConfig {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9.nodeTaint.NodeTaintMetadata,
	Taint: interface{},
	FieldManager: *string,
	Force: interface{},
	Id: *string,
