...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v8/rolev1"
...
&rolev1.RoleV1Config {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v8.roleV1.RoleV1Metadata,
	Rule: interface{},
	Id: *string,
}
```
...
| <code><a href="#@cdktf/provider-kubernetes.roleV1.RoleV1Config.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.22.0/docs/resources/role_v1#id RoleV1#id}. |
