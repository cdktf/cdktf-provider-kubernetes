...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v12/rolev1"
...
&rolev1.RoleV1Config {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v12.roleV1.RoleV1Metadata,
	Rule: interface{},
	Id: *string,
}
```
