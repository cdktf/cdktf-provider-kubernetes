...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v8/configmapv1"
...
&configmapv1.ConfigMapV1Config {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v8.configMapV1.ConfigMapV1Metadata,
