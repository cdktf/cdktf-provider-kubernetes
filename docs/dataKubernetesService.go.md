...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9/datakubernetesservice"
...
&datakubernetesservice.DataKubernetesServiceConfig {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9.dataKubernetesService.DataKubernetesServiceMetadata,
	Id: *string,
}
```
