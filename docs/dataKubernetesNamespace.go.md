...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v8/datakubernetesnamespace"
...
&datakubernetesnamespace.DataKubernetesNamespaceConfig {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v8.dataKubernetesNamespace.DataKubernetesNamespaceMetadata,
	Id: *string,
}
```
