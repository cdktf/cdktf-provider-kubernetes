...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v5/datakubernetesnamespace"
...
&datakubernetesnamespace.DataKubernetesNamespaceConfig {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v5.dataKubernetesNamespace.DataKubernetesNamespaceMetadata,
	Id: *string,
}
```
