...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9/datakubernetesnamespace"
...
&datakubernetesnamespace.DataKubernetesNamespaceConfig {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9.dataKubernetesNamespace.DataKubernetesNamespaceMetadata,
	Id: *string,
}
```
