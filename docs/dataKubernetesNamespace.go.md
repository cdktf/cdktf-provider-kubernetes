...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v12/datakubernetesnamespace"
...
&datakubernetesnamespace.DataKubernetesNamespaceConfig {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v12.dataKubernetesNamespace.DataKubernetesNamespaceMetadata,
	Id: *string,
}
```
