...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v7/datakubernetesnamespace"
...
&datakubernetesnamespace.DataKubernetesNamespaceConfig {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v7.dataKubernetesNamespace.DataKubernetesNamespaceMetadata,
	Id: *string,
}
```
