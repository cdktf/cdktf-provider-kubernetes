...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v12/configmapv1data"
...
Refer to the {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.38.0/docs/resources/config_map_v1_data#import import section} in the documentation of this resource for the id to use
...
&configmapv1data.ConfigMapV1DataConfig {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v12.configMapV1Data.ConfigMapV1DataMetadata,
	FieldManager: *string,
	Force: interface{},
	Id: *string,
}
...
| <code><a href="#@cdktf/provider-kubernetes.configMapV1Data.ConfigMapV1DataConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.38.0/docs/resources/config_map_v1_data#id ConfigMapV1Data#id}. |
