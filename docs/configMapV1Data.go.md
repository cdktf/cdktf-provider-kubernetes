...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v7/configmapv1data"
...
&configmapv1data.ConfigMapV1DataConfig {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v7.configMapV1Data.ConfigMapV1DataMetadata,
	FieldManager: *string,
	Force: interface{},
	Id: *string,
}
