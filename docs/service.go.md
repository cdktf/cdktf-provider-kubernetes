...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9/service"
...
&service.ServiceConfig {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9.service.ServiceMetadata,
	Spec: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9.service.ServiceSpec,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9.service.ServiceTimeouts,
...
| <code><a href="#@cdktf/provider-kubernetes.service.ServiceConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.23.0/docs/resources/service#id Service#id}. |
...
&service.ServiceSpec {
	...
	SessionAffinityConfig: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9.service.ServiceSpecSessionAffinityConfig,
	Type: *string,
}
```
...
&service.ServiceSpecSessionAffinityConfig {
	ClientIp: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9.service.ServiceSpecSessionAffinityConfigClientIp,
}
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-kubernetes.service.ServiceTimeouts.property.create">Create</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.23.0/docs/resources/service#create Service#create}. |
