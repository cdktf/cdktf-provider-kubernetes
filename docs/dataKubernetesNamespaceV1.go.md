...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v8/datakubernetesnamespacev1"
...
&datakubernetesnamespacev1.DataKubernetesNamespaceV1Config {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v8.dataKubernetesNamespaceV1.DataKubernetesNamespaceV1Metadata,
	Id: *string,
}
```
...
| <code><a href="#@cdktf/provider-kubernetes.dataKubernetesNamespaceV1.DataKubernetesNamespaceV1Config.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.22.0/docs/data-sources/namespace_v1#id DataKubernetesNamespaceV1#id}. |
