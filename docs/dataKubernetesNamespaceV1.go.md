...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9/datakubernetesnamespacev1"
...
&datakubernetesnamespacev1.DataKubernetesNamespaceV1Config {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9.dataKubernetesNamespaceV1.DataKubernetesNamespaceV1Metadata,
	Id: *string,
}
```
