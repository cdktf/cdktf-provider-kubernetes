...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v7/namespacev1"
...
&namespacev1.NamespaceV1Config {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v7.namespaceV1.NamespaceV1Metadata,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v7.namespaceV1.NamespaceV1Timeouts,
}
```
