...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v5/datakubernetesresource"
...
| <code><a href="#@cdktf/provider-kubernetes.dataKubernetesResource.DataKubernetesResource.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&datakubernetesresource.DataKubernetesResourceConfig {
	...
	ApiVersion: *string,
	Kind: *string,
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v5.dataKubernetesResource.DataKubernetesResourceMetadata,
...
| <code><a href="#@cdktf/provider-kubernetes.dataKubernetesResource.DataKubernetesResourceConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
