...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v7/role"
...
&role.RoleConfig {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v7.role.RoleMetadata,
	Rule: interface{},
	Id: *string,
}
```
