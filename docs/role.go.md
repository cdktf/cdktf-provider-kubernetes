...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v12/role"
...
&role.RoleConfig {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v12.role.RoleMetadata,
	Rule: interface{},
	Id: *string,
}
```
...
| <code><a href="#@cdktf/provider-kubernetes.role.RoleConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.37.1/docs/resources/role#id Role#id}. |
