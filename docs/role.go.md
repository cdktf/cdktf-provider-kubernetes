...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9/role"
...
&role.RoleConfig {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9.role.RoleMetadata,
	Rule: interface{},
	Id: *string,
}
```
