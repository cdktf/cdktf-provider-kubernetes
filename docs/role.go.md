...
| <code><a href="#@cdktf/provider-kubernetes.role.RoleConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.19.0/docs/resources/role#id Role#id}. |
...
| <code><a href="#@cdktf/provider-kubernetes.role.RoleMetadata.property.name">Name</a></code> | <code>*string</code> | Name of the role, must be unique. Cannot be updated. More info: http://kubernetes.io/docs/user-guide/identifiers#names. |
