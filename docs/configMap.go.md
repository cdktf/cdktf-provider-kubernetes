...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v5/configmap"
...
&configmap.ConfigMapConfig {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v5.configMap.ConfigMapMetadata,
