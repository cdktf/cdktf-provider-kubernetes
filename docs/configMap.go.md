...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v8/configmap"
...
&configmap.ConfigMapConfig {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v8.configMap.ConfigMapMetadata,
