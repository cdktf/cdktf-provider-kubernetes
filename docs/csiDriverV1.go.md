...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9/csidriverv1"
...
&csidriverv1.CsiDriverV1Config {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9.csiDriverV1.CsiDriverV1Metadata,
	Id: *string,
	Spec: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9.csiDriverV1.CsiDriverV1Spec,
}
```
