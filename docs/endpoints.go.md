...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v7/endpoints"
...
&endpoints.EndpointsConfig {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v7.endpoints.EndpointsMetadata,
	Id: *string,
	Subset: interface{},
}
```
