...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9/endpoints"
...
&endpoints.EndpointsConfig {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9.endpoints.EndpointsMetadata,
	Id: *string,
	Subset: interface{},
}
```
