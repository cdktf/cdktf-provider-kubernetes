...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v6/endpoints"
...
&endpoints.EndpointsConfig {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v6.endpoints.EndpointsMetadata,
	Id: *string,
	Subset: interface{},
}
```
...
| <code><a href="#@cdktf/provider-kubernetes.endpoints.EndpointsConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.21.0/docs/resources/endpoints#id Endpoints#id}. |
