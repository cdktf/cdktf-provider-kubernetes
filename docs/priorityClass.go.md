...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v7/priorityclass"
...
&priorityclass.PriorityClassConfig {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v7.priorityClass.PriorityClassMetadata,
	Value: *f64,
	Description: *string,
