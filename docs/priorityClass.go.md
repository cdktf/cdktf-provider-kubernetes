...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v12/priorityclass"
...
&priorityclass.PriorityClassConfig {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v12.priorityClass.PriorityClassMetadata,
	Value: *f64,
	Description: *string,
