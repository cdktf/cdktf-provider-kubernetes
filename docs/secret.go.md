...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v7/secret"
...
&secret.SecretConfig {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v7.secret.SecretMetadata,
	BinaryData: *map[string]*string,
	Data: *map[string]*string,
	Id: *string,
	Immutable: interface{},
	Timeouts: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v7.secret.SecretTimeouts,
	Type: *string,
