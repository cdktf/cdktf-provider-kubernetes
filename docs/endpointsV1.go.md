...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v7/endpointsv1"
...
&endpointsv1.EndpointsV1Config {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v7.endpointsV1.EndpointsV1Metadata,
	Id: *string,
	Subset: interface{},
}
```
