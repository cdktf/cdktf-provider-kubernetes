...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9/endpointsv1"
...
&endpointsv1.EndpointsV1Config {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9.endpointsV1.EndpointsV1Metadata,
	Id: *string,
	Subset: interface{},
}
```
