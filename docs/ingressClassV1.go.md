...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v8/ingressclassv1"
...
&ingressclassv1.IngressClassV1Config {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v8.ingressClassV1.IngressClassV1Metadata,
	Spec: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v8.ingressClassV1.IngressClassV1Spec,
	Id: *string,
}
```
