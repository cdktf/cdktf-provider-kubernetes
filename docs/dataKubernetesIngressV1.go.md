...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9/datakubernetesingressv1"
...
&datakubernetesingressv1.DataKubernetesIngressV1Config {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9.dataKubernetesIngressV1.DataKubernetesIngressV1Metadata,
	Id: *string,
}
```
