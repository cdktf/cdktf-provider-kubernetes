...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v8/datakubernetesingressv1"
...
&datakubernetesingressv1.DataKubernetesIngressV1Config {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v8.dataKubernetesIngressV1.DataKubernetesIngressV1Metadata,
	Id: *string,
}
```
