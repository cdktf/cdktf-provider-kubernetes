...
Refer to the Terraform Registory for docs: [`data_kubernetes_ingress_v1`](https://registry.terraform.io/providers/hashicorp/kubernetes/2.20.0/docs/data-sources/ingress_v1).
...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v6/datakubernetesingressv1"
...
&datakubernetesingressv1.DataKubernetesIngressV1Config {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v6.dataKubernetesIngressV1.DataKubernetesIngressV1Metadata,
	Id: *string,
}
```
...
| <code><a href="#@cdktf/provider-kubernetes.dataKubernetesIngressV1.DataKubernetesIngressV1Config.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.20.0/docs/data-sources/ingress_v1#id DataKubernetesIngressV1#id}. |
