...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v8/runtimeclassv1"
...
&runtimeclassv1.RuntimeClassV1Config {
	...
	Handler: *string,
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v8.runtimeClassV1.RuntimeClassV1Metadata,
	Id: *string,
}
```
