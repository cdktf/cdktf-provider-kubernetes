...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v7/runtimeclassv1"
...
&runtimeclassv1.RuntimeClassV1Config {
	...
	Handler: *string,
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v7.runtimeClassV1.RuntimeClassV1Metadata,
	Id: *string,
}
```
