...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v8/datakubernetesendpointsv1"
...
&datakubernetesendpointsv1.DataKubernetesEndpointsV1Config {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v8.dataKubernetesEndpointsV1.DataKubernetesEndpointsV1Metadata,
	Id: *string,
	Subset: interface{},
}
```
