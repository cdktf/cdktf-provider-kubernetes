...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v7/datakubernetesendpointsv1"
...
&datakubernetesendpointsv1.DataKubernetesEndpointsV1Config {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v7.dataKubernetesEndpointsV1.DataKubernetesEndpointsV1Metadata,
	Id: *string,
	Subset: interface{},
}
```
