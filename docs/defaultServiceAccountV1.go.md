...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9/defaultserviceaccountv1"
...
&defaultserviceaccountv1.DefaultServiceAccountV1Config {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9.defaultServiceAccountV1.DefaultServiceAccountV1Metadata,
	AutomountServiceAccountToken: interface{},
	Id: *string,
	ImagePullSecret: interface{},
	Secret: interface{},
	Timeouts: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9.defaultServiceAccountV1.DefaultServiceAccountV1Timeouts,
}
```
