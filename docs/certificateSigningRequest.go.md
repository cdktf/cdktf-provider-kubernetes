...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9/certificatesigningrequest"
...
&certificatesigningrequest.CertificateSigningRequestConfig {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9.certificateSigningRequest.CertificateSigningRequestMetadata,
	Spec: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9.certificateSigningRequest.CertificateSigningRequestSpec,
	AutoApprove: interface{},
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9.certificateSigningRequest.CertificateSigningRequestTimeouts,
}
```
