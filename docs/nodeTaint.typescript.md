...
Refer to the Terraform Registory for docs: [`kubernetes_node_taint`](https://www.terraform.io/docs/providers/kubernetes/r/node_taint).
...
```typescript
public putTaint(value: NodeTaintTaint): void
```
...
| <code><a href="#@cdktf/provider-kubernetes.nodeTaint.NodeTaint.property.count">count</a></code> | <code>number</code> | *No description.* |
...
```typescript
public readonly taint: NodeTaintTaintOutputReference;
```
...
```typescript
public readonly taintInput: NodeTaintTaint;
```
...
| <code><a href="#@cdktf/provider-kubernetes.nodeTaint.NodeTaintConfig.property.count">count</a></code> | <code>number</code> | *No description.* |
...
```typescript
public readonly taint: NodeTaintTaint;
```
...
new nodeTaint.NodeTaintTaintOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string)
```
...
```typescript
public readonly internalValue: NodeTaintTaint;
```
