...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v7/datakubernetesnodes"
...
&datakubernetesnodes.DataKubernetesNodesConfig {
	...
	Id: *string,
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v7.dataKubernetesNodes.DataKubernetesNodesMetadata,
}
```
