...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v7/datakubernetespersistentvolumeclaim"
...
&datakubernetespersistentvolumeclaim.DataKubernetesPersistentVolumeClaimConfig {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v7.dataKubernetesPersistentVolumeClaim.DataKubernetesPersistentVolumeClaimMetadata,
	Id: *string,
	Spec: interface{},
}
```
