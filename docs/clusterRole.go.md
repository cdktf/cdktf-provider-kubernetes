...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9/clusterrole"
...
&clusterrole.ClusterRoleConfig {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9.clusterRole.ClusterRoleMetadata,
	AggregationRule: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9.clusterRole.ClusterRoleAggregationRule,
	Id: *string,
	Rule: interface{},
}
```
