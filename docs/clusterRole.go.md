...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v7/clusterrole"
...
&clusterrole.ClusterRoleConfig {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v7.clusterRole.ClusterRoleMetadata,
	AggregationRule: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v7.clusterRole.ClusterRoleAggregationRule,
	Id: *string,
	Rule: interface{},
}
```
