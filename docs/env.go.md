...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v12/env"
...
&env.EnvConfig {
	...
	Env: interface{},
	Kind: *string,
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v12.env.EnvMetadata,
	Container: *string,
	FieldManager: *string,
	Force: interface{},
	Id: *string,
...
&env.EnvEnv {
	Name: *string,
	Value: *string,
	ValueFrom: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v12.env.EnvEnvValueFrom,
}
```
...
&env.EnvEnvValueFrom {
	ConfigMapKeyRef: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v12.env.EnvEnvValueFromConfigMapKeyRef,
	FieldRef: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v12.env.EnvEnvValueFromFieldRef,
	ResourceFieldRef: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v12.env.EnvEnvValueFromResourceFieldRef,
	SecretKeyRef: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v12.env.EnvEnvValueFromSecretKeyRef,
}
```
