...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v8/datakubernetesconfigmap"
...
&datakubernetesconfigmap.DataKubernetesConfigMapConfig {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v8.dataKubernetesConfigMap.DataKubernetesConfigMapMetadata,
	Id: *string,
	Immutable: interface{},
}
```
