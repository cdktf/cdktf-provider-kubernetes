...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9/datakubernetesconfigmap"
...
&datakubernetesconfigmap.DataKubernetesConfigMapConfig {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9.dataKubernetesConfigMap.DataKubernetesConfigMapMetadata,
	Id: *string,
	Immutable: interface{},
}
```
