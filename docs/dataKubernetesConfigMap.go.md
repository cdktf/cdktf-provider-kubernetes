...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v5/datakubernetesconfigmap"
...
| <code><a href="#@cdktf/provider-kubernetes.dataKubernetesConfigMap.DataKubernetesConfigMap.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&datakubernetesconfigmap.DataKubernetesConfigMapConfig {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v5.dataKubernetesConfigMap.DataKubernetesConfigMapMetadata,
	Id: *string,
	Immutable: interface{},
}
```
...
| <code><a href="#@cdktf/provider-kubernetes.dataKubernetesConfigMap.DataKubernetesConfigMapConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
