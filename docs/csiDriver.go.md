...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9/csidriver"
...
&csidriver.CsiDriverConfig {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9.csiDriver.CsiDriverMetadata,
	Id: *string,
	Spec: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9.csiDriver.CsiDriverSpec,
}
```
