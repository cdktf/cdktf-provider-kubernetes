...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v7/csidriver"
...
&csidriver.CsiDriverConfig {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v7.csiDriver.CsiDriverMetadata,
	Id: *string,
	Spec: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v7.csiDriver.CsiDriverSpec,
}
```
