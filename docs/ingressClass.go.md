...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v7/ingressclass"
...
&ingressclass.IngressClassConfig {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v7.ingressClass.IngressClassMetadata,
	Spec: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v7.ingressClass.IngressClassSpec,
	Id: *string,
}
```
