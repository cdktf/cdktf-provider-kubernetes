...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v12/ingressclass"
...
&ingressclass.IngressClassConfig {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v12.ingressClass.IngressClassMetadata,
	Spec: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v12.ingressClass.IngressClassSpec,
	Id: *string,
}
```
