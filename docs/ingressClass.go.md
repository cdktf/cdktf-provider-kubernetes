...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9/ingressclass"
...
&ingressclass.IngressClassConfig {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9.ingressClass.IngressClassMetadata,
	Spec: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9.ingressClass.IngressClassSpec,
	Id: *string,
}
```
