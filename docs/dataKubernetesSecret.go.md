...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9/datakubernetessecret"
...
&datakubernetessecret.DataKubernetesSecretConfig {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9.dataKubernetesSecret.DataKubernetesSecretMetadata,
