...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9/datakubernetesserviceaccountv1"
...
&datakubernetesserviceaccountv1.DataKubernetesServiceAccountV1Config {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9.dataKubernetesServiceAccountV1.DataKubernetesServiceAccountV1Metadata,
	Id: *string,
}
```
