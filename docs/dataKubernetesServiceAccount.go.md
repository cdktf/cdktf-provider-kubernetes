...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v7/datakubernetesserviceaccount"
...
&datakubernetesserviceaccount.DataKubernetesServiceAccountConfig {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v7.dataKubernetesServiceAccount.DataKubernetesServiceAccountMetadata,
	Id: *string,
}
```
