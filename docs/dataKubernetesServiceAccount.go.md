...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v8/datakubernetesserviceaccount"
...
&datakubernetesserviceaccount.DataKubernetesServiceAccountConfig {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v8.dataKubernetesServiceAccount.DataKubernetesServiceAccountMetadata,
	Id: *string,
}
```
