...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v6/servicev1"
...
| <code><a href="#@cdktf/provider-kubernetes.serviceV1.ServiceV1.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&servicev1.ServiceV1Config {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v6.serviceV1.ServiceV1Metadata,
	Spec: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v6.serviceV1.ServiceV1Spec,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v6.serviceV1.ServiceV1Timeouts,
...
| <code><a href="#@cdktf/provider-kubernetes.serviceV1.ServiceV1Config.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&servicev1.ServiceV1Spec {
	...
	SessionAffinityConfig: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v6.serviceV1.ServiceV1SpecSessionAffinityConfig,
	Type: *string,
}
```
...
&servicev1.ServiceV1SpecSessionAffinityConfig {
	ClientIp: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v6.serviceV1.ServiceV1SpecSessionAffinityConfigClientIp,
}
```
