...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v8/servicev1"
...
&servicev1.ServiceV1Config {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v8.serviceV1.ServiceV1Metadata,
	Spec: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v8.serviceV1.ServiceV1Spec,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v8.serviceV1.ServiceV1Timeouts,
...
&servicev1.ServiceV1Spec {
	...
	SessionAffinityConfig: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v8.serviceV1.ServiceV1SpecSessionAffinityConfig,
	Type: *string,
}
```
...
&servicev1.ServiceV1SpecSessionAffinityConfig {
	ClientIp: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v8.serviceV1.ServiceV1SpecSessionAffinityConfigClientIp,
}
```
