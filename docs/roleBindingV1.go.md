...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9/rolebindingv1"
...
&rolebindingv1.RoleBindingV1Config {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9.roleBindingV1.RoleBindingV1Metadata,
	RoleRef: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9.roleBindingV1.RoleBindingV1RoleRef,
	Subject: interface{},
	Id: *string,
}
```
