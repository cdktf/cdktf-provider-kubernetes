...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v6/limitrangev1"
...
&limitrangev1.LimitRangeV1Config {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v6.limitRangeV1.LimitRangeV1Metadata,
	Id: *string,
	Spec: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v6.limitRangeV1.LimitRangeV1Spec,
}
```
...
| <code><a href="#@cdktf/provider-kubernetes.limitRangeV1.LimitRangeV1Config.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.19.0/docs/resources/limit_range_v1#id LimitRangeV1#id}. |
