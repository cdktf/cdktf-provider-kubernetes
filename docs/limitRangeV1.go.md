...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v7/limitrangev1"
...
&limitrangev1.LimitRangeV1Config {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v7.limitRangeV1.LimitRangeV1Metadata,
	Id: *string,
	Spec: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v7.limitRangeV1.LimitRangeV1Spec,
}
```
