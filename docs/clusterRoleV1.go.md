...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v7/clusterrolev1"
...
&clusterrolev1.ClusterRoleV1Config {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v7.clusterRoleV1.ClusterRoleV1Metadata,
	AggregationRule: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v7.clusterRoleV1.ClusterRoleV1AggregationRule,
	Id: *string,
	Rule: interface{},
}
```
