...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9/clusterrolev1"
...
&clusterrolev1.ClusterRoleV1Config {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9.clusterRoleV1.ClusterRoleV1Metadata,
	AggregationRule: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9.clusterRoleV1.ClusterRoleV1AggregationRule,
	Id: *string,
	Rule: interface{},
}
```
