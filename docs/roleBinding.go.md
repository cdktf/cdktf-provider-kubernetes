...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v7/rolebinding"
...
&rolebinding.RoleBindingConfig {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v7.roleBinding.RoleBindingMetadata,
	RoleRef: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v7.roleBinding.RoleBindingRoleRef,
	Subject: interface{},
	Id: *string,
}
```
