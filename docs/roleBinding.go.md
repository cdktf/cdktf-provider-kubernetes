...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v12/rolebinding"
...
&rolebinding.RoleBindingConfig {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v12.roleBinding.RoleBindingMetadata,
	RoleRef: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v12.roleBinding.RoleBindingRoleRef,
	Subject: interface{},
	Id: *string,
}
```
...
| <code><a href="#@cdktf/provider-kubernetes.roleBinding.RoleBindingConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.37.1/docs/resources/role_binding#id RoleBinding#id}. |
