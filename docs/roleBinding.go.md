...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9/rolebinding"
...
&rolebinding.RoleBindingConfig {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9.roleBinding.RoleBindingMetadata,
	RoleRef: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9.roleBinding.RoleBindingRoleRef,
	Subject: interface{},
	Id: *string,
}
```
