...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v6/apiservice"
...
| <code><a href="#@cdktf/provider-kubernetes.apiService.ApiService.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&apiservice.ApiServiceConfig {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v6.apiService.ApiServiceMetadata,
	Spec: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v6.apiService.ApiServiceSpec,
	Id: *string,
}
```
...
| <code><a href="#@cdktf/provider-kubernetes.apiService.ApiServiceConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-kubernetes.apiService.ApiServiceConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/kubernetes/r/api_service#id ApiService#id}. |
...
&apiservice.ApiServiceSpec {
	...
	Service: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v6.apiService.ApiServiceSpecService,
}
```
