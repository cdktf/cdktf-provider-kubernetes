...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v12/apiservice"
...
&apiservice.ApiServiceConfig {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v12.apiService.ApiServiceMetadata,
	Spec: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v12.apiService.ApiServiceSpec,
	Id: *string,
}
```
...
&apiservice.ApiServiceSpec {
	...
	Service: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v12.apiService.ApiServiceSpecService,
}
```
