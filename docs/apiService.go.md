...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9/apiservice"
...
&apiservice.ApiServiceConfig {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9.apiService.ApiServiceMetadata,
	Spec: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9.apiService.ApiServiceSpec,
	Id: *string,
}
```
...
| <code><a href="#@cdktf/provider-kubernetes.apiService.ApiServiceConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.23.0/docs/resources/api_service#id ApiService#id}. |
...
&apiservice.ApiServiceSpec {
	...
	Service: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9.apiService.ApiServiceSpecService,
}
```
