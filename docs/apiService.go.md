...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v8/apiservice"
...
&apiservice.ApiServiceConfig {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v8.apiService.ApiServiceMetadata,
	Spec: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v8.apiService.ApiServiceSpec,
	Id: *string,
}
```
...
&apiservice.ApiServiceSpec {
	...
	Service: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v8.apiService.ApiServiceSpecService,
}
```
