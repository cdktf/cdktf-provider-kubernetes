...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v7/limitrange"
...
&limitrange.LimitRangeConfig {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v7.limitRange.LimitRangeMetadata,
	Id: *string,
	Spec: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v7.limitRange.LimitRangeSpec,
}
```
