...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v8/limitrange"
...
&limitrange.LimitRangeConfig {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v8.limitRange.LimitRangeMetadata,
	Id: *string,
	Spec: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v8.limitRange.LimitRangeSpec,
}
```
