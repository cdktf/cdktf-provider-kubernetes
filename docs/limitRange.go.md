...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v12/limitrange"
...
&limitrange.LimitRangeConfig {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v12.limitRange.LimitRangeMetadata,
	Id: *string,
	Spec: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v12.limitRange.LimitRangeSpec,
}
```
...
| <code><a href="#@cdktf/provider-kubernetes.limitRange.LimitRangeConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.38.0/docs/resources/limit_range#id LimitRange#id}. |
