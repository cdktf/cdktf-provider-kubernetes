...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9/datakubernetesingress"
...
&datakubernetesingress.DataKubernetesIngressConfig {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9.dataKubernetesIngress.DataKubernetesIngressMetadata,
	Id: *string,
}
```
