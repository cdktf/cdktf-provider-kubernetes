...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v7/datakubernetesingress"
...
&datakubernetesingress.DataKubernetesIngressConfig {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v7.dataKubernetesIngress.DataKubernetesIngressMetadata,
	Id: *string,
}
```
