...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v8/datakubernetesingress"
...
&datakubernetesingress.DataKubernetesIngressConfig {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v8.dataKubernetesIngress.DataKubernetesIngressMetadata,
	Id: *string,
}
```
