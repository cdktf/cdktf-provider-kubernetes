...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v12/datakubernetesingress"
...
&datakubernetesingress.DataKubernetesIngressConfig {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v12.dataKubernetesIngress.DataKubernetesIngressMetadata,
	Id: *string,
}
```
