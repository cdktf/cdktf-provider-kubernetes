...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v8/poddisruptionbudgetv1"
...
&poddisruptionbudgetv1.PodDisruptionBudgetV1Config {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v8.podDisruptionBudgetV1.PodDisruptionBudgetV1Metadata,
	Spec: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v8.podDisruptionBudgetV1.PodDisruptionBudgetV1Spec,
	Id: *string,
}
```
...
&poddisruptionbudgetv1.PodDisruptionBudgetV1Spec {
	Selector: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v8.podDisruptionBudgetV1.PodDisruptionBudgetV1SpecSelector,
