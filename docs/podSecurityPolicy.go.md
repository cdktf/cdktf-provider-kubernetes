...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9/podsecuritypolicy"
...
&podsecuritypolicy.PodSecurityPolicyConfig {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9.podSecurityPolicy.PodSecurityPolicyMetadata,
	Spec: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9.podSecurityPolicy.PodSecurityPolicySpec,
	Id: *string,
}
```
...
&podsecuritypolicy.PodSecurityPolicySpec {
	FsGroup: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9.podSecurityPolicy.PodSecurityPolicySpecFsGroup,
	RunAsUser: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9.podSecurityPolicy.PodSecurityPolicySpecRunAsUser,
	SupplementalGroups: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9.podSecurityPolicy.PodSecurityPolicySpecSupplementalGroups,
	...
	RunAsGroup: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9.podSecurityPolicy.PodSecurityPolicySpecRunAsGroup,
	SeLinux: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9.podSecurityPolicy.PodSecurityPolicySpecSeLinux,
	Volumes: *[]*string,
}
```
