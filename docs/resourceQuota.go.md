...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v7/resourcequota"
...
&resourcequota.ResourceQuotaConfig {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v7.resourceQuota.ResourceQuotaMetadata,
	Id: *string,
	Spec: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v7.resourceQuota.ResourceQuotaSpec,
	Timeouts: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v7.resourceQuota.ResourceQuotaTimeouts,
}
```
...
&resourcequota.ResourceQuotaSpec {
	...
	Scopes: *[]*string,
	ScopeSelector: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v7.resourceQuota.ResourceQuotaSpecScopeSelector,
}
```
