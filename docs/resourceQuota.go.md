...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9/resourcequota"
...
&resourcequota.ResourceQuotaConfig {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9.resourceQuota.ResourceQuotaMetadata,
	Id: *string,
	Spec: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9.resourceQuota.ResourceQuotaSpec,
	Timeouts: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9.resourceQuota.ResourceQuotaTimeouts,
}
```
...
&resourcequota.ResourceQuotaSpec {
	...
	Scopes: *[]*string,
	ScopeSelector: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v9.resourceQuota.ResourceQuotaSpecScopeSelector,
}
```
