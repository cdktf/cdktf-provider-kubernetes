...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v8/resourcequota"
...
&resourcequota.ResourceQuotaConfig {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v8.resourceQuota.ResourceQuotaMetadata,
	Id: *string,
	Spec: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v8.resourceQuota.ResourceQuotaSpec,
	Timeouts: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v8.resourceQuota.ResourceQuotaTimeouts,
}
```
...
&resourcequota.ResourceQuotaSpec {
	...
	Scopes: *[]*string,
	ScopeSelector: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v8.resourceQuota.ResourceQuotaSpecScopeSelector,
}
```
