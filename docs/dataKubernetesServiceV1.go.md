...
```go
import "github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v8/datakubernetesservicev1"
...
&datakubernetesservicev1.DataKubernetesServiceV1Config {
	...
	Metadata: github.com/cdktf/cdktf-provider-kubernetes-go/kubernetes/v8.dataKubernetesServiceV1.DataKubernetesServiceV1Metadata,
	Id: *string,
}
```
