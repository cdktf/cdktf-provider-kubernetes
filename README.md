...
# CDKTF prebuilt bindings for hashicorp/kubernetes provider version 2.27.0

This repo builds and publishes the [Terraform kubernetes provider](https://registry.terraform.io/providers/hashicorp/kubernetes/2.27.0/docs) bindings for [CDK for Terraform](https://cdk.tf).
...
- [Terraform kubernetes provider](https://registry.terraform.io/providers/hashicorp/kubernetes/2.27.0)
