...
export function namespaceTimeoutsToTerraform(struct?: NamespaceTimeoutsOutputReference | NamespaceTimeouts): any {
  if (!cdktf.canInspect(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class Namespace extends cdktf.TerraformResource {
  ...
  */
  ...
  private _metadata = new NamespaceMetadataOutputReference(this as any, "metadata", true);
  public get metadata() {
  ...
  private _timeouts = new NamespaceTimeoutsOutputReference(this as any, "timeouts", true);
  public get timeouts() {
