// https://registry.terraform.io/providers/hashicorp/kubernetes/2.37.0/docs/resources/service
...
export class Service extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Service that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.37.0/docs/resources/service#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.37.0/docs/resources/service kubernetes_service} Resource
  *
  * @param scope The scope in which to define this construct
