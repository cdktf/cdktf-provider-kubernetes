...
// https://registry.terraform.io/providers/hashicorp/kubernetes/2.27.0/docs/resources/csi_driver_v1
...
export class CsiDriverV1 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CsiDriverV1 that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.27.0/docs/resources/csi_driver_v1#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.27.0/docs/resources/csi_driver_v1 kubernetes_csi_driver_v1} Resource
  *
  * @param scope The scope in which to define this construct
