// https://registry.terraform.io/providers/hashicorp/kubernetes/2.35.1/docs/resources/network_policy
...
export class NetworkPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing NetworkPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.35.1/docs/resources/network_policy#import import section} in the documentation of this resource for the id to use
