...
function podSpecContainerResourcesLimitsToTerraform(struct?: PodSpecContainerResourcesLimits): any {
  if (!cdktf.canInspect(struct)) { return struct; }
  return {
...
function podSpecContainerResourcesRequestsToTerraform(struct?: PodSpecContainerResourcesRequests): any {
  if (!cdktf.canInspect(struct)) { return struct; }
  return {
    cpu: cdktf.stringToTerraform(struct!.cpu),
    memory: cdktf.stringToTerraform(struct!.memory),
...
function podSpecContainerResourcesToTerraform(struct?: PodSpecContainerResources): any {
  if (!cdktf.canInspect(struct)) { return struct; }
  return {
    limits: cdktf.listMapper(podSpecContainerResourcesLimitsToTerraform)(struct!.limits),
    requests: cdktf.listMapper(podSpecContainerResourcesRequestsToTerraform)(struct!.requests),
  }
}
...
function podSpecInitContainerResourcesLimitsToTerraform(struct?: PodSpecInitContainerResourcesLimits): any {
  if (!cdktf.canInspect(struct)) { return struct; }
  return {
    cpu: cdktf.stringToTerraform(struct!.cpu),
    memory: cdktf.stringToTerraform(struct!.memory),
...
function podSpecInitContainerResourcesRequestsToTerraform(struct?: PodSpecInitContainerResourcesRequests): any {
  if (!cdktf.canInspect(struct)) { return struct; }
  return {
    cpu: cdktf.stringToTerraform(struct!.cpu),
    memory: cdktf.stringToTerraform(struct!.memory),
...
function podSpecInitContainerResourcesToTerraform(struct?: PodSpecInitContainerResources): any {
  if (!cdktf.canInspect(struct)) { return struct; }
  return {
    limits: cdktf.listMapper(podSpecInitContainerResourcesLimitsToTerraform)(struct!.limits),
    requests: cdktf.listMapper(podSpecInitContainerResourcesRequestsToTerraform)(struct!.requests),
  }
}
