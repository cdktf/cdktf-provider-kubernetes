...
// https://registry.terraform.io/providers/hashicorp/kubernetes/2.31.0/docs/data-sources/namespace
...
export interface DataKubernetesNamespaceConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.31.0/docs/data-sources/namespace#id DataKubernetesNamespace#id}
  *
  ...
  * metadata block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.31.0/docs/data-sources/namespace#metadata DataKubernetesNamespace#metadata}
  */
  readonly metadata: DataKubernetesNamespaceMetadata;
}
export interface DataKubernetesNamespaceSpec {
}

export function dataKubernetesNamespaceSpecToTerraform(struct?: DataKubernetesNamespaceSpec): any {
...
export class DataKubernetesNamespaceSpecOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataKubernetesNamespaceSpec | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataKubernetesNamespaceSpec | undefined) {
    if (value === undefined) {
...
export class DataKubernetesNamespaceSpecList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataKubernetesNamespaceSpecOutputReference {
    return new DataKubernetesNamespaceSpecOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface DataKubernetesNamespaceMetadata {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.31.0/docs/data-sources/namespace#annotations DataKubernetesNamespace#annotations}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.31.0/docs/data-sources/namespace#labels DataKubernetesNamespace#labels}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.31.0/docs/data-sources/namespace#name DataKubernetesNamespace#name}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.31.0/docs/data-sources/namespace kubernetes_namespace}
*/
export class DataKubernetesNamespace extends cdktf.TerraformDataSource {
  ...
  * @param importToId The construct id used in the generated config for the DataKubernetesNamespace to import
  * @param importFromId The id of the existing DataKubernetesNamespace that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.31.0/docs/data-sources/namespace#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.31.0/docs/data-sources/namespace kubernetes_namespace} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _spec = new DataKubernetesNamespaceSpecList(this, "spec", false);
  public get spec() {
    return this._spec;
  }

  // metadata - computed: false, optional: false, required: true
  private _metadata = new DataKubernetesNamespaceMetadataOutputReference(this, "metadata");
  public get metadata() {
