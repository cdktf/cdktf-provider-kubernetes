// https://registry.terraform.io/providers/hashicorp/kubernetes/2.33.0/docs/resources/runtime_class_v1
...
export class RuntimeClassV1 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RuntimeClassV1 that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.33.0/docs/resources/runtime_class_v1#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.33.0/docs/resources/runtime_class_v1 kubernetes_runtime_class_v1} Resource
  *
  * @param scope The scope in which to define this construct
