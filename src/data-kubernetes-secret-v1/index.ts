...
// https://registry.terraform.io/providers/hashicorp/kubernetes/2.37.1/docs/data-sources/secret_v1
...
export class DataKubernetesSecretV1 extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataKubernetesSecretV1 that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.37.1/docs/data-sources/secret_v1#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.37.1/docs/data-sources/secret_v1 kubernetes_secret_v1} Data Source
  *
  * @param scope The scope in which to define this construct
