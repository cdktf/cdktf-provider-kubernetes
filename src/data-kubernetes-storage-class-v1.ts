...
function dataKubernetesStorageClassV1AllowedTopologiesMatchLabelExpressionsToTerraform(struct?: DataKubernetesStorageClassV1AllowedTopologiesMatchLabelExpressions): any {
...
function dataKubernetesStorageClassV1AllowedTopologiesToTerraform(struct?: DataKubernetesStorageClassV1AllowedTopologiesOutputReference | DataKubernetesStorageClassV1AllowedTopologies): any {
  if (!cdktf.canInspect(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataKubernetesStorageClassV1AllowedTopologiesOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  private _matchLabelExpressions?: DataKubernetesStorageClassV1AllowedTopologiesMatchLabelExpressions[] | undefined; 
  public get matchLabelExpressions() {
    // Getting the computed value is not yet implemented
    return this.interpolationForAttribute('match_label_expressions') as any;
  }
  public set matchLabelExpressions(value: DataKubernetesStorageClassV1AllowedTopologiesMatchLabelExpressions[] | undefined) {
...
function dataKubernetesStorageClassV1MetadataToTerraform(struct?: DataKubernetesStorageClassV1MetadataOutputReference | DataKubernetesStorageClassV1Metadata): any {
  if (!cdktf.canInspect(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataKubernetesStorageClassV1 extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _allowedTopologies?: DataKubernetesStorageClassV1AllowedTopologies | undefined; 
  private __allowedTopologiesOutput = new DataKubernetesStorageClassV1AllowedTopologiesOutputReference(this as any, "allowed_topologies", true);
  public get allowedTopologies() {
    return this.__allowedTopologiesOutput;
  }
  public putAllowedTopologies(value: DataKubernetesStorageClassV1AllowedTopologies | undefined) {
  ...
  private _metadata?: DataKubernetesStorageClassV1Metadata; 
  private __metadataOutput = new DataKubernetesStorageClassV1MetadataOutputReference(this as any, "metadata", true);
  public get metadata() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      allowed_topologies: dataKubernetesStorageClassV1AllowedTopologiesToTerraform(this._allowedTopologies),
      metadata: dataKubernetesStorageClassV1MetadataToTerraform(this._metadata),
    };
  }
}
