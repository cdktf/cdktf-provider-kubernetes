// https://registry.terraform.io/providers/hashicorp/kubernetes/2.31.0/docs
...
export class KubernetesProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing KubernetesProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.31.0/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.31.0/docs kubernetes} Resource
  *
  * @param scope The scope in which to define this construct
