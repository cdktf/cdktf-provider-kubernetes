...
function clusterRoleBindingV1MetadataToTerraform(struct?: ClusterRoleBindingV1MetadataOutputReference | ClusterRoleBindingV1Metadata): any {
...
function clusterRoleBindingV1RoleRefToTerraform(struct?: ClusterRoleBindingV1RoleRefOutputReference | ClusterRoleBindingV1RoleRef): any {
  if (!cdktf.canInspect(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
function clusterRoleBindingV1SubjectToTerraform(struct?: ClusterRoleBindingV1Subject): any {
  if (!cdktf.canInspect(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class ClusterRoleBindingV1 extends cdktf.TerraformResource {
  ...
  */
  ...
  private _metadata?: ClusterRoleBindingV1Metadata; 
  private __metadataOutput = new ClusterRoleBindingV1MetadataOutputReference(this as any, "metadata", true);
  public get metadata() {
  ...
  private _roleRef?: ClusterRoleBindingV1RoleRef; 
  private __roleRefOutput = new ClusterRoleBindingV1RoleRefOutputReference(this as any, "role_ref", true);
  public get roleRef() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      metadata: clusterRoleBindingV1MetadataToTerraform(this._metadata),
      role_ref: clusterRoleBindingV1RoleRefToTerraform(this._roleRef),
