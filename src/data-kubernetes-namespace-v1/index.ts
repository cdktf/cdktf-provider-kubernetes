// https://registry.terraform.io/providers/hashicorp/kubernetes/2.26.0/docs/data-sources/namespace_v1
...
export class DataKubernetesNamespaceV1 extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataKubernetesNamespaceV1 that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.26.0/docs/data-sources/namespace_v1#import import section} in the documentation of this resource for the id to use
