...
// https://registry.terraform.io/providers/hashicorp/kubernetes/2.28.0/docs/resources/ingress_class
...
export class IngressClass extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IngressClass that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.28.0/docs/resources/ingress_class#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.28.0/docs/resources/ingress_class kubernetes_ingress_class} Resource
  *
  * @param scope The scope in which to define this construct
