...
export interface DeploymentV1Config extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.33.0/docs/resources/deployment_v1#id DeploymentV1#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.33.0/docs/resources/deployment_v1#wait_for_rollout DeploymentV1#wait_for_rollout}
  */
  ...
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.33.0/docs/resources/deployment_v1#timeouts DeploymentV1#timeouts}
  */
  readonly timeouts?: DeploymentV1Timeouts;
}

/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.33.0/docs/resources/deployment_v1 kubernetes_deployment_v1}
*/
export class DeploymentV1 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DeploymentV1 that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.33.0/docs/resources/deployment_v1#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.33.0/docs/resources/deployment_v1 kubernetes_deployment_v1} Resource
  *
  * @param scope The scope in which to define this construct
