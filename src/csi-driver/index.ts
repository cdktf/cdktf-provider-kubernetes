...
// https://registry.terraform.io/providers/hashicorp/kubernetes/2.26.0/docs/resources/csi_driver
...
export class CsiDriver extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CsiDriver that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.26.0/docs/resources/csi_driver#import import section} in the documentation of this resource for the id to use
