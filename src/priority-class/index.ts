// https://registry.terraform.io/providers/hashicorp/kubernetes/2.25.1/docs/resources/priority_class
...
export class PriorityClass extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PriorityClass that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.25.1/docs/resources/priority_class#import import section} in the documentation of this resource for the id to use
