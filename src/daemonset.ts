...
export interface DaemonsetConfig extends TerraformMetaArguments {
  /** metadata block */
...
export class Daemonset extends TerraformResource {
  ...
  public set timeouts(value: DaemonsetTimeouts | undefined) {
