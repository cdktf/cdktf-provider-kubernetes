// https://registry.terraform.io/providers/hashicorp/kubernetes/2.27.0/docs/resources/annotations
...
export class Annotations extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Annotations that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.27.0/docs/resources/annotations#import import section} in the documentation of this resource for the id to use
