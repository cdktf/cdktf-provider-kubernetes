// https://registry.terraform.io/providers/hashicorp/kubernetes/2.26.0/docs/resources/pod_security_policy
...
export class PodSecurityPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing PodSecurityPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.26.0/docs/resources/pod_security_policy#import import section} in the documentation of this resource for the id to use
