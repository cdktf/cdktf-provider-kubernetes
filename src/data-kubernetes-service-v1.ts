...
function dataKubernetesServiceV1MetadataToTerraform(struct?: DataKubernetesServiceV1MetadataOutputReference | DataKubernetesServiceV1Metadata): any {
...
export class DataKubernetesServiceV1 extends cdktf.TerraformDataSource {
  ...
  */
  ...
  private _metadata?: DataKubernetesServiceV1Metadata; 
  private __metadataOutput = new DataKubernetesServiceV1MetadataOutputReference(this as any, "metadata", true);
  public get metadata() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      metadata: dataKubernetesServiceV1MetadataToTerraform(this._metadata),
    };
  }
}
