...
export interface DaemonSetV1SpecTemplateSpec {
  ...
  * 
  * Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/kubernetes/r/daemon_set_v1#scheduler_name DaemonSetV1#scheduler_name}
  */
...
export function daemonSetV1TimeoutsToTerraform(struct?: DaemonSetV1TimeoutsOutputReference | DaemonSetV1Timeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
