...
export class DaemonSetV1 extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DaemonSetV1 that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.35.0/docs/resources/daemon_set_v1#import import section} in the documentation of this resource for the id to use
