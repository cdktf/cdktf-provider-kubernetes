...
export class DataKubernetesPod extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataKubernetesPod that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/kubernetes/2.28.0/docs/data-sources/pod#import import section} in the documentation of this resource for the id to use
